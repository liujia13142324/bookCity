<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
<table id="editGoods" style="height:100%">
<div id="tb" style="text-align: right">
<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-save',plain:true">保存(内存)</a>
...
<script type="text/javascript" src="js/goodsEdit.js"></script>
